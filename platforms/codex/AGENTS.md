...
### Skill: Spec-Driven Development (`spec-driven-development`)
...
### Skill: Code Review and Quality (`code-review-and-quality`)
...
- [Debugging and Error Recovery](https://github.com/addyosmani/agent-skills/blob/main/skills/debugging-and-error-recovery/SKILL.md) — verify
- [Doubt-Driven Development](https://github.com/addyosmani/agent-skills/blob/main/skills/doubt-driven-development/SKILL.md) — build
- [Planning and Task Breakdown](https://github.com/addyosmani/agent-skills/blob/main/skills/planning-and-task-breakdown/SKILL.md) — plan
- [Security and Hardening](https://github.com/addyosmani/agent-skills/blob/main/skills/security-and-hardening/SKILL.md) — review
